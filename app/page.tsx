  ...
  return (
    <main className="relative min-h-screen text-white overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col px-6">
        ...
        <section className="pt-16 pb-20 w-full">
          <div className="mx-auto max-w-5xl">
            <div className="flex items-center justify-between gap-4">
              ...
              {/* ✅ MULTI-PAGE NAV (Confessions scrolls, others link) */}
              <div className="flex flex-wrap items-center justify-end gap-2">
                <button className={btnGhost} onClick={() => scrollToId("confessions")}>
                  Confessions
                </button>

                <Link className={btnGhost} href="/forge">
                  Forge
                </Link>
                <Link className={btnGhost} href="/roadmap">
                  Roadmap
                </Link>
                <Link className={btnGhost} href="/memes">
                  Memes
                </Link>
              </div>
            </div>
            ...
            <div className="mt-12">
              ...
              <div className="mt-9 flex flex-wrap gap-3">
                {/* ✅ goes to /forge now */}
                <button className={btnPrimary} onClick={() => router.push("/forge")}>
                  Forge Identity
                </button>
        ...
        {/* ✅ CONFESSIONS (kept on home) */}
        <section id="confessions" className="py-20 w-full max-w-4xl mx-auto">
          {/* --- everything below this point can stay exactly as you had it --- */}
          {/* I’m not re-pasting the whole rest of your file here to keep this readable. */}
          {/* Paste your original CONFESSIONS + DEX + SOCIALS + FOOTER sections here unchanged. */}

          {/* NOTE: remove or move the old in-page sections:
              - <section id="forge">...</section>
              - <section id="status">...</section>
              - <section id="roadmap">...</section>
              - <section id="memes">...</section>
              if those are now separate pages.
          */}
        ...
        {/* keep the rest of your sections (Dex, Socials, footer) as-is */}
      </div>
    </main>
  );
}
