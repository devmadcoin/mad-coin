        ...
        {scrolled && (
          <div className="border-b border-white/10 bg-white/[0.02]">
            <div className="mx-auto max-w-7xl px-4 py-2 flex items-center justify-center gap-3 text-sm">
              ...
              <code className="text-red-400 font-mono text-xs truncate max-w-[200px] sm:max-w-sm">{CA}</code>
              <CopyButton />
            </div>
          </div>
        )}
        ...
        <div className="fixed inset-0 z-40 bg-black/98 backdrop-blur-xl pt-24 px-6 lg:hidden">
          <div className="flex flex-col gap-2">
            ...
            <div className="mt-6 p-4 bg-white/[0.03] border border-white/10 rounded-2xl">
              <p className="text-white/40 text-sm mb-2">Contract Address</p>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-4 flex items-center justify-center gap-2 py-4 bg-red-500 text-white font-black rounded-full"
            >
              Buy $MAD
            </a>
          </div>
  ...
  return (
    <div className={`group relative overflow-hidden rounded-[28px] border ${borderClass} min-h-[220px] transition duration-300 hover:scale-[1.01]`}>
      <div className="absolute inset-0">
        <Image src={image} alt={title} fill className="object-cover transition duration-500 group-hover:scale-[1.04]" sizes="(max-width: 1024px) 100vw, 33vw" />
      </div>
...
export default function Home() {
  ...
  const tokenStats = [
    { label: "PRICE", value: "$0.0002841", change: "+12.4%", isPositive: true },
    { label: "MARKET CAP", value: "$284.1K", change: "+8.2%", isPositive: true },
    { label: "HOLDERS", value: "2,847", change: "+156", isPositive: true },
    { label: "24H VOLUME", value: "$42.8K", change: "-3.1%", isPositive: false },
    { label: "TOTAL BURNED", value: "400M+", change: undefined, isPositive: true },
  ];
  ...
  const howToBuySteps = [
    {
      number: "01",
      title: "Get a Wallet",
      description: "Download Phantom Wallet from your app store or browser extension. Create a new wallet and securely save your recovery phrase.",
    ...
    },
    {
      number: "02",
      title: "Buy SOL",
      description: "Purchase SOL from an exchange like Coinbase, Binance, or Kraken. Send it to your Phantom wallet address.",
    ...
    },
    {
      ...
      description: "Visit Jupiter Exchange and connect your Phantom wallet. Make sure you're on the Solana network.",
      link: "https://jup.ag",
    ...
    },
    {
      number: "04",
      title: "Swap for $MAD",
      description: "Paste the $MAD contract address, enter how much SOL you want to swap, and confirm the transaction. Welcome to the club.",
      link: LINKS.buy,
  ...
  const socials = [
    { name: "Telegram", icon: <Send size={18} />, href: LINKS.telegram },
    { name: "X / Twitter", icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>, href: LINKS.x },
      ...
      <main className="mx-auto max-w-7xl px-4 pb-24 pt-6 sm:px-6 lg:px-8">
          ...
          <div className="relative z-10 grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
            <div>
              ...
              <div className="mt-7 flex flex-wrap gap-3">
                ...
                <Btn href={LINKS.buy} primary>Buy $MAD</Btn>
              </div>
          ...
          <div className="mb-6 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            <div>
              ...
              <h2 className="mt-2 text-2xl font-black leading-[0.95] text-white sm:text-3xl md:text-4xl">
                Token <span className="text-red-500">Stats</span>
              </h2>
            </div>
        ...
        <section id="how-to-buy" className="mt-10 rounded-[38px] border border-white/10 bg-black/40 p-6 shadow-[0_18px_70px_rgba(0,0,0,0.35)] backdrop-blur-xl sm:p-8 lg:p-10">
          <div className="mb-8">
            ...
            <h2 className="mt-2 text-2xl font-black leading-[0.95] text-white sm:text-3xl md:text-4xl">
              How to <span className="text-red-500">Buy $MAD</span>
            </h2>
            <p className="mt-3 text-sm text-white/50 max-w-xl">
              Four simple steps to join the $MAD movement. No complex DeFi knowledge needed.
            </p>
          </div>
          ...
          <div className="mt-8 p-6 bg-white/[0.02] border border-white/10 rounded-[24px]">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              <div>
                <p className="text-white/40 text-sm mb-1">Contract Address (Solana)</p>
        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <p className="text-white/50 text-sm leading-relaxed mb-6">
                Controlled chaos. Discipline wins. $MAD is more than a token — it&apos;s a mindset.
              </p>
              <div className="flex items-center gap-2">
                {socials.map((s) => (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="w-10 h-10 bg-white/5 hover:bg-red-500/10 border border-white/5 hover:border-red-500/20 rounded-xl flex items-center justify-center text-white/40 hover:text-red-400 transition-all"
                    title={s.name}
                  >
                    {s.icon}
                  </a>
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                {[
                  ...
                  { label: "DEX Screener", href: LINKS.dexscreener },
                  { label: "Birdeye", href: LINKS.birdeye },
                  { label: "Solscan", href: LINKS.solscan },
                ].map((link) => (
                  <li key={link.label}>
                    <a href={link.href} target="_blank" rel="noreferrer" className="text-white/50 hover:text-white text-sm transition-colors inline-flex items-center gap-1">
                      {link.label}
            ...
            <div>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="mt-3 flex items-center justify-center gap-2 py-3 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl text-white text-sm font-bold transition-all"
              >
          ...
          <div className="pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-white/40 text-xs">
              &copy; {new Date().getFullYear()} $MAD. All rights reserved. Built by the community.
            </p>
            <p className="text-white/40 text-xs">
              Stay $MAD. Controlled chaos. Discipline wins.
            </p>
          </div>
        </div>
      </footer>
