...
KNOWLEDGE_DROPS = {
    ...
    "practical": [
        ...
        "Discipline weighs ounces. Regret weighs tons.  Small effort today > massive regret tomorrow.",
        "Either you run the day, or the day runs you.  Who's driving today?",
        "Formal education will make you a living. Self-education will make you a fortune.  What are you studying right now?",
    ],
    "questions": [
        ...
        "The 6 Human Needs drive every decision: Certainty, Uncertainty, Significance, Connection, Growth, Contribution.  Which 3 needs does $MAD meet for you? (When 3 needs are met, you become addicted.)",
        "Most people overestimate what they can do in a year and underestimate what they can do in a decade.  What are you building that won't show results for 10 years?",
        "The market is a device for transferring money from the impatient to the patient. "Don't wish it were easier; wish you were better.  What skill are you building right now that will make the next challenge effortless?", "If you don't design your own life plan, chances are you'll fall into someone else's plan.  Whose plan are you in right now?", "Time is more valuable than money. You can get more money, but you cannot get more time.  How are you investing your hours today?",  Which one are you?",
    ],
    "affirmations": [
        ...
        "Discipline is the bridge between goals and accomplishment.  What simple discipline can you practice today that your future self will thank you for?",
        "Success is nothing more than a few simple disciplines, practiced every day.  What's your one discipline? The thing you do regardless of mood?",
        "Work harder on yourself than you do on your job.  If you work hard on your job, you make a living. If you work hard on yourself, you make a fortune.",
        "You are the average of the five people you spend the most time with.  Who are your five? And what frequency are they tuned to?",
    ],
    "conviction": [
        ...
        "the few who do are the envy of the many who only watch.  which one are you?",
        "learn how to be happy with what you have while you pursue what you want.  conviction is happiness with your position while you build toward the vision.",
...
async def on_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not is_mentioned and not is_reply_to_bot:
        # DO NOT reply to random messages - only when @mentioned or replied to
        # Conversation state, loose commands, buy detection - all blocked here.
        return
