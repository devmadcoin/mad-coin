          ...
          <div className="p-6 sm:p-10">
            ...
            <div className="text-center">
              ...
              <div className="mt-3 flex items-baseline justify-center gap-2">
                <span className="text-4xl sm:text-6xl font-black tracking-tight text-white">10,000,000</span>
              ...
              <div className="ml-14 sm:ml-20 rounded-[1.4rem] border border-[#FF6B00]/30 bg-[#FF6B00]/[0.04] p-5 sm:p-6">
                ...
                <div className="mt-3">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-[10px] font-black text-[#FF6B00]">28%</span>
                  </div>
                  <div className="h-2 rounded-full bg-[#1a1a1a]/[0.06] overflow-hidden">
                    <div className="h-full rounded-full bg-[#FF6B00] w-[28%] shadow-[0_0_10px_rgba(255,107,0,0.3)]" />
                  </div>
                </div>

                <p className="mt-3 text-xs text-[#1a1a1a]/50">
                  📈 +34.74% today · 159 txns (79 buys vs 80 sells) · 63 traders active
                </p>
              </div>
            </div>
