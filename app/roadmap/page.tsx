...
export default function Home() {
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      {/* IMPORTANT: keep everything centered and not full-width */}
      <div className="relative mx-auto max-w-6xl px-6 pt-16 pb-24">
        {/* HERO */}
        <section className="max-w-3xl animate-fadeUp">
        ...
        <section
          id="chart"
          className="mt-16 animate-fadeUp scroll-mt-32"
        >
          {/* Keep chart content aligned with the hero width */}
