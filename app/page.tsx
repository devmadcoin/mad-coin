...
export default function Home() {
  ...
  async function copyAddr() {
    try {
      ...
      // fallback: do nothing (prevents crash if clipboard blocked)
      setCopied(false);
    }
  }
    ...
    <div className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-6xl px-6 py-16">
        <div className="max-w-3xl">
          ...
          <h1 className="mt-4 text-5xl font-black tracking-tight sm:text-6xl text-white">
          ...
          <section className="mt-10">
            <div className="rounded-3xl border border-white/10 bg-black/30 backdrop-blur overflow-hidden">
              <div className="flex items-center justify-between px-5 py-4 border-b border-white/10">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="rounded-full px-4 py-2 text-sm font-black border border-white/10 bg-white/5 hover:bg-white/10 transition text-white"
                >
                  Open ↗
                </a>
              </div>
