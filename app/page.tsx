  ...
  return (
    <section className="px-4 sm:px-6 py-20 sm:py-28 bg-[#F5F1E8]">
      <div className="max-w-3xl mx-auto">
        ...
        {/* Stats */}
        <div className="mt-12 pt-10 border-t border-[#1a1a1a]/10 grid grid-cols-2 sm:grid-cols-4 gap-6">
          <div>
      ...
      <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <span className="block text-[#1a1a1a]/40 text-[9px] tracking-[0.3em] uppercase">Stay $MAD</span>
          </div>
        </div>
        <p className="text-[#1a1a1a]/35 text-[10px] font-medium">
          Doxxed. Building. Not asking permission.
        </p>
        <div className="flex items-center gap-1 text-[#1a1a1a]/25 text-[10px]">
          <span>Contract:</span>
