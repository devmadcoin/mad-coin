...
export const LINKS = {
  ...
  youtube: "https://www.youtube.com/@coffeecollectshq",
  lockProof: `https://solscan.io/token/${CA}`,
};

export const EXCHANGES = [
  { name: "Jupiter", img: "/exchanges/jupiter.png", url: `https://jup.ag/tokens/${CA}` },
  { name: "DEXScreener", img: "/exchanges/dexscreener.png", url: `https://dexscreener.com/solana/${PAIR}` },
  { name: "Solscan", img: "/exchanges/solscan.png", url: `https://solscan.io/token/${CA}` },
  { name: "Birdeye", img: "/exchanges/birdeye.png", url: `https://birdeye.so/solana/token/${CA}` },
  { name: "OKX", img: "/exchanges/okx.png", url: `https://web3.okx.com/token/solana/${CA}` },
  { name: "Gate.io", img: "/exchanges/gate.png", url: `https://www.gate.com/alpha/sol-${CA}` },
  { name: "MEXC", img: "/exchanges/mexc.png", url: "https://www.mexc.com/dex/trade" },
];
...
export const TESTIMONIALS: Testimonial[] = [
  {
    name: "Sapient",
    handle: "@sapient_ru",
    pfp: "/testimonials/sapient-pfp.png",
  ...
  },
  {
    ...
    pfp: "/testimonials/dkwtt-chadwick-pfp.png",
    quote: "Ordered the $MAD American Dad hat on the day that my Dad passed. This is not just a hat to me — it's Motivation, Alignment & Discipline.",
    proof: "/testimonials/dkwtt-mad-hat-game.png",
  },
  {
    name: "Dino",
    handle: "@Iam__dino9",
    pfp: "/testimonials/dino-pfp.png",
    ...
    proof: "/testimonials/dino-stickers.png",
  },
  {
    name: "Heydun",
    handle: "@Grpx_Heydun",
    pfp: "/testimonials/heydun-pfp.png",
    quote: "Keep building, believe, never stop. Every small step changes the future. The $MAD community is strong and unstoppable.",
    url: "https://x.com/Grpx_Heydun/status/2070831387914170412",
  },
  {
    name: "IDC Lord",
    handle: "@idclord",
    pfp: "/testimonials/idclord-pfp.png",
    quote: "Brought $MAD to campus. Showed the game to my friends. Now they're holders too. Organic growth, real believers.",
  },
  {
    name: "Kimdunk77",
    handle: "@kimdunk77",
    pfp: "/testimonials/kimdunk77-pfp.png",
  ...
  },
  {
    name: "M Luffy",
    handle: "@mluffy_onsol",
    pfp: "/testimonials/mluffy-pfp.png",
  ...
  },
  {
    ...
    pfp: "/testimonials/treshon-pfp.png",
    quote: "Thanks to the $MAD team for listening to me. Thank you for impacting the next generation. Thank you so much $MAD.",
...
export const TEAM = [
  {
    ...
    name: "$MAD Dev",
    sub: "Coffee Collects",
    img: "/team/mad-dev-coffee-collects.png",
    links: [
  ...
  },
  {
    ...
    name: "crypto guru",
    sub: "@followdv80",
    img: "/rewards/crypto-guru-followdv80.png",
  ...
  },
  {
    ...
    sub: "@Derrick152667",
    img: "/rewards/perspective-360-kakashi.png",
  ...
  },
  {
    ...
    name: "Heydun",
    sub: "@Grpx_Heydun",
    img: "/team/mad-artist-heydun.png",
