...
export default function Home() {
  ...
  // Dexscreener embed (safe + simple)
  const dexEmbed = `https://dexscreener.com/solana/${addr}?embed=1&theme=dark&trades=0&info=0`;
        ...
        <section className="mt-12">
          <div className="flex items-end justify-between gap-4 flex-wrap">
            <div>
              ...
              <h2 className="mt-2 text-2xl sm:text-3xl font-black">Track Momentum</h2>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="rounded-full border border-white/10 bg-white/5 px-5 py-2 text-sm font-semibold text-white/85 hover:bg-white/10 transition"
            >
              Open on Dexscreener →
            </a>
          </div>

          <div className="mt-5 rounded-2xl border border-white/10 bg-black/30 backdrop-blur overflow-hidden">
