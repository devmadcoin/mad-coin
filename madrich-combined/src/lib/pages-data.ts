...
export const COMMUNITIES = [
  { logo: "/community/normie.png", name: "Normie", handle: "@NormieCEO", platform: "X", description: "Locked 1.0344M Normie tokens via Streamflow to support the Normie community ecosystem.", amountUSD: 1061, tokenAmount: 1_034_400, tokenSymbol: "NORMIE", txHash: "2KDGBDDab2AQCBwnF1eWsEupVUdgS6uHMGtVD2CXJ7j9", xPost: "https://x.com/madrichclub_/status/2052921091342107024", date: "2025-04-15" },
  { logo: "/community/derpydave.png", name: "DerpyDave", handle: "@Being_DerpyAF", platform: "X", description: "Locked 8.155M $DERPYDAVE tokens via Streamflow. Non-cancelable until 2060.", amountUSD: 758, tokenAmount: 8_155_000, tokenSymbol: "DERPYDAVE", txHash: "2Qg5Ugf2eH12ry9w3StU9sMvo5biuruK7ob2sni2Yref", xPost: "https://x.com/madrichclub_/status/2053391015109955771", date: "2025-04-18" },
  { logo: "/community/theluxxlounge.png", name: "TheLuxxLounge", handle: "@TheLuxxLounge", platform: "X", description: "Locked 1,036,883 $TLLT tokens via Streamflow. Non-cancelable until 2060.", amountUSD: 284, tokenAmount: 1_036_883, tokenSymbol: "TLLT", txHash: "4noTMqJg5w6noGRGEnDaUcFHFUhhcHvG9ALT31c7mcBR", xPost: "https://x.com/madrichclub_/status/2057508965567877497", date: "2025-05-01" },
  { logo: "/community/hiney.png", name: "HINEY", handle: "@hineycoin", platform: "X", description: "Locked 1,027,002 $HINEY tokens via Streamflow. Non-cancelable until 2060.", amountUSD: 169, tokenAmount: 1_027_002, tokenSymbol: "HINEY", txHash: "61gPdDSq4Qcft5rNkLr6iFaTefU7UdtSHWPpwbtveuGW", xPost: "https://x.com/madrichclub_/status/2058759994485715249", date: "2025-05-08" },
  { logo: "/community/touchgrass.png", name: "TouchGrass", handle: "@XTouchGrass", platform: "X", description: "Locked 1,019,634 $TOUCHGRASS tokens via Streamflow. Non-cancelable until 2060.", amountUSD: 132, tokenAmount: 1_019_634, tokenSymbol: "TOUCHGRASS", txHash: "CUTM1NuyFpoU5UNmXbjiRtJRL53dssyWrDkX9Xv6ziiy", xPost: "https://x.com/madrichclub_/status/2060080223954346354", date: "2025-05-12" },
  { logo: "/community/stash.png", name: "Stash", handle: "@gostashxyz", platform: "X", description: "Locked 33,890 $STASH tokens via Streamflow. Non-cancelable until 2060.", amountUSD: 124, tokenAmount: 33_890, tokenSymbol: "STASH", txHash: "FvH6cCN9vNAEqXFsQrYrAjoKD1Bs12BqqVKokWc66xiS", xPost: "https://x.com/madrichclub_/status/2062897412516217028", date: "2025-05-20" },
...
export const ART_LOOPS = [
  { src: "/mad-art/loops/mad-thinking.mp4", label: "MAD Thinking" },
  { src: "/mad-art/loops/hahaha.mp4", label: "HAHAHA" },
  { src: "/mad-art/loops/mad-excited.mp4", label: "MAD Excited" },
  { src: "/mad-art/loops/mad-spirit-bomb.mp4", label: "MAD Spirit Bomb" },
  { src: "/mad-art/loops/super-mad.mp4", label: "SUPER MAD" },
];

export const GALLERY: { src: string; title: string; tag: string }[] = [
  { src: "/mad-art/mad-cyber-troll-v2.jpg", title: "Cyber Troll", tag: "Character" },
  { src: "/mad-art/mad-jungle-pill.jpg", title: "Jungle Pill", tag: "Scene" },
  { src: "/mad-art/mad-morning-cereal.jpg", title: "Morning Cereal", tag: "Character" },
  { src: "/memes/MAD-2-MONTHS.png", title: "2 Months", tag: "Milestone" },
  { src: "/memes/MAD-3-MONTHS.png", title: "3 Months", tag: "Milestone" },
  { src: "/memes/MAD-ARMY.png", title: "MAD Army", tag: "Community" },
  { src: "/memes/MAD-ART-1.png", title: "MAD Art #1", tag: "Digital" },
  { src: "/memes/MAD-ART-2.png", title: "MAD Art #2", tag: "Digital" },
  { src: "/memes/MAD-ART-3.png", title: "MAD Art #3", tag: "Digital" },
  { src: "/memes/MAD-ART-4.png", title: "MAD Art #4", tag: "Digital" },
  { src: "/memes/MAD-AT-BEARS.png", title: "At Bears", tag: "Meme" },
  { src: "/memes/MAD-BELIEVE.png", title: "Believe", tag: "Meme" },
  { src: "/memes/MAD-BELIEVING.png", title: "Believing", tag: "Meme" },
  { src: "/memes/MAD-COMMUNITY.png", title: "Community", tag: "Community" },
  { src: "/memes/MAD-DOCTOR.png", title: "Doctor", tag: "Meme" },
  { src: "/memes/MAD-DOLLAR.png", title: "MAD Dollar", tag: "Meme" },
  { src: "/memes/MAD-HOLD-ON-DEAR-LIFE.png", title: "HODL", tag: "Meme" },
  { src: "/memes/MAD-KINGS-ONLY.png", title: "Kings Only", tag: "Meme" },
  { src: "/memes/MAD-LAST-FARM.png", title: "Last Farm", tag: "Meme" },
  { src: "/memes/MAD-NEPTUNE.png", title: "Neptune", tag: "Digital" },
  { src: "/memes/MAD-RED-EYE.png", title: "Red Eye", tag: "Meme" },
  { src: "/memes/MAD-RICH-BATH.png", title: "Rich Bath", tag: "Digital" },
  { src: "/memes/MAD-RICH-IN-THE-TUB.png", title: "Rich in Tub", tag: "Digital" },
  { src: "/memes/MAD-RICH-OR-BROKE.png", title: "Rich or Broke", tag: "Meme" },
  { src: "/memes/MAD-ROLLERCOASTER.png", title: "Rollercoaster", tag: "Meme" },
  { src: "/memes/MAD-SCAM-CALL.png", title: "Scam Call", tag: "Meme" },
  { src: "/memes/MAD-SCHOOL.png", title: "MAD School", tag: "Meme" },
  { src: "/memes/MAD-YOU-SIDELINED.png", title: "Sidelined", tag: "Meme" },
  { src: "/memes/MAKE-MAD-GREAT-AGAIN.png", title: "Make MAD Great", tag: "Meme" },
  { src: "/memes/WE-MAD-ZOOMIN.png", title: "We MAD Zoomin'", tag: "Meme" },
  { src: "/memes/YOU-MAKE-ME-MAD.png", title: "You Make Me MAD", tag: "Meme" },
  { src: "/memes/YOU-WILL-BE-MAD.png", title: "You Will Be MAD", tag: "Meme" },
  { src: "/mad-art/mad-attitude.png", title: "MAD Attitude", tag: "Character" },
  { src: "/mad-art/mad-this-is-fine.png", title: "This Is Fine", tag: "Meme" },
  { src: "/mad-art/mad-donut-temptation.png", title: "Donut Temptation", tag: "Meme" },
  { src: "/mad-art/mad-stay-mad-soldier.png", title: "STAY $MAD Soldier", tag: "Character" },
  { src: "/mad-art/mad-car-wash-rain.png", title: "Car Wash Curse", tag: "Meme" },
];
...
export const PROOF_PHOTOS = [
  { img: "/testimonials/dino-stickers.png", caption: "Got my sticker. Laptop game strong.", by: "@Iam__dino9" },
  { img: "/testimonials/dkwtt-mad-hat-game.png", caption: "Hydrated and $MAD.", by: "@lit_terrestrial" },
];
