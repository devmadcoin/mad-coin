export default function Home() {
  const addr = "Fa7ZE9nCENyrHsnoeHuhExJpchtrBtXNwe6CgHpump";
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6">
        ...
        <div className="mt-10 flex gap-4 flex-wrap justify-center">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="rounded-full border border-white/30 px-8 py-3 font-bold hover:bg-white hover:text-black transition"
          >
            View Chart
          </a>
        </div>
        ...
        <div className="mt-8 space-y-2 text-lg">
          <p>$HAPPY farmed me.</p>
          <p>$SAD farmed me.</p>
          <p className="text-red-500 font-bold text-2xl">$MAD made me.</p>
        </div>
