      ...
      <nav className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-3 sm:px-6">
        ...
        <div className="no-scrollbar flex-1 overflow-x-auto whitespace-nowrap [-webkit-overflow-scrolling:touch]">
          <div className="flex w-max items-center gap-2 pl-1 pr-10">
            ...
            <NavPill href="/merch" pathname={pathname}>
              Merch
            </NavPill>
    ...
    <Link
      ...
      className={[
        ...
        active
          ...
          : "border-white/10 bg-white/5 text-white/90 hover:bg-white/10 hover:text-white hover:border-red-500/30 hover:shadow-[0_0_12px_rgba(255,0,0,0.35)]",
      ].join(" ")}
    >
      {children}
    </Link>
