...
export const IMPACT_STATS = [
  { value: 8, label: "Communities Supported", icon: "🤝" },
  { value: 65049, prefix: "$", label: "Total Donated", icon: "💰" },
  { value: 27.5, suffix: "M", label: "$MAD Tokens Given", icon: "🔥", decimals: 1 },
  { value: 500, suffix: "M", label: "Tokens Burned", icon: "🔥" },
];

export const COMMUNITIES = [
  { name: "Normie", handle: "@NormieCEO", usd: 1061, amount: "1.03M", ticker: "NORMIE", note: "Locked 1.0344M Normie tokens via Streamflow to support the Normie community ecosystem.", post: "https://x.com/madrichclub_/status/2052921091342107024", verify: "https://app.streamflow.finance/contract/solana/mainnet/2KDGBDDab2AQCBwnF1eWsEupVUdgS6uHMGtVD2CXJ7j9" },
  { name: "DerpyDave", handle: "@Being_DerpyAF", usd: 758, amount: "8.16M", ticker: "DERPYDAVE", note: "Locked 8.155M $DERPYDAVE tokens via Streamflow. Non-cancelable until 2060.", post: "https://x.com/madrichclub_/status/2053391015109955771", verify: "https://app.streamflow.finance/contract/solana/mainnet/2Qg5Ugf2eH12ry9w3StU9sMvo5biuruK7ob2sni2Yref" },
  { name: "TheLuxxLounge", handle: "@TheLuxxLounge", usd: 284, amount: "1.04M", ticker: "TLLT", note: "Locked 1,036,883 $TLLT tokens via Streamflow. Non-cancelable until 2060.", post: "https://x.com/madrichclub_/status/2057508965567877497", verify: "https://app.streamflow.finance/contract/solana/mainnet/4noTMqJg5w6noGRGEnDaUcFHFUhhcHvG9ALT31c7mcBR" },
  { name: "HINEY", handle: "@hineycoin", usd: 169, amount: "1.03M", ticker: "HINEY", note: "Locked 1,027,002 $HINEY tokens via Streamflow. Non-cancelable until 2060.", post: "https://x.com/madrichclub_/status/2058759994485715249", verify: "https://app.streamflow.finance/contract/solana/mainnet/61gPdDSq4Qcft5rNkLr6iFaTefU7UdtSHWPpwbtveuGW" },
  { name: "TouchGrass", handle: "@XTouchGrass", usd: 132, amount: "1.02M", ticker: "TOUCHGRASS", note: "Locked 1,019,634 $TOUCHGRASS tokens via Streamflow. Non-cancelable until 2060.", post: "https://x.com/madrichclub_/status/2060080223954346354", verify: "https://app.streamflow.finance/contract/solana/mainnet/CUTM1NuyFpoU5UNmXbjiRtJRL53dssyWrDkX9Xv6ziiy" },
  { name: "Stash", handle: "@gostashxyz", usd: 124, amount: "0.03M", ticker: "STASH", note: "Locked 33,890 $STASH tokens via Streamflow. Non-cancelable until 2060.", post: "https://x.com/madrichclub_/status/2062897412516217028", verify: "https://app.streamflow.finance/contract/solana/mainnet/FvH6cCN9vNAEqXFsQrYrAjoKD1Bs12BqqVKokWc66xiS" },
  { name: "RandyCoin", handle: "@RandyCoinAI", usd: 72, amount: "1.75M", ticker: "RNDY", note: "Locked 1,754,679 $RNDY tokens via Streamflow. Non-cancelable until 2060.", post: "https://x.com/madrichclub_/status/2063766619059638771", verify: "https://app.streamflow.finance/contract/solana/mainnet/HBkYVaUT3GB1iGWxJhaMGNsYLnVvaL1ymo5ML8aoTZuR" },
  { name: "DIGIKOINZ", handle: "@DIGI_KOINZ", usd: 70, amount: "1.04M", ticker: "KOINZ", note: "Locked 1,038,763 $KOINZ tokens via Streamflow. Non-cancelable until 2060.", post: "https://x.com/madrichclub_/status/2074232348292661547", verify: "https://app.streamflow.finance/contract/solana/mainnet/J73caZFu4pUBCmU9QjLqJkLX4uX3xkHBQ7M2LHG1sUc5" },
];
...
export const PRODUCTS = [
  { name: "MAD Stickers", tier: "Classic", stock: "In Stock", price: "$5.98", img: "/assets/merch/sticker.png", desc: "Clean, bold, and easy to place anywhere. The easiest way to carry $MAD into the real world.", url: "https://notaveragestickers.com/products/mad-%F0%9F%98%A1-sticker" },
  { name: "Card Wrap", tier: "Premium", stock: "Selling Fast", price: "$10.98", img: "/assets/merch/card-wrap.png", desc: "A sharper premium look with texture and attitude.", url: "https://notaveragestickers.com/products/mad-%F0%9F%98%A1-premium-embossed-card-wrap" },
  { name: "Rich Wrap", tier: "Luxury", stock: "Low Stock", price: "$10.98", img: "/assets/merch/rich-wrap.png", desc: "The louder luxury version with richer flex energy.", url: "https://notaveragestickers.com/products/mad-%F0%9F%98%A1-premium-embossed-card-wrap-copy" },
  { name: "Peeker", tier: "Fan Favorite", stock: "In Stock", price: "$9.98", img: "/assets/merch/peeker.png", desc: "Small piece. Fast attention. Big signal.", url: "https://notaveragestickers.com/products/mad-%F0%9F%98%A1-peeker" },
];
