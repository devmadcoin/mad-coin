...
/* ─── SHARED COMPONENTS (no animations) ─── */
...
function LiveTicker() {
 ...
 if (loading) {
 return (
 <div className="fixed top-0 left-0 right-0 z-[60] bg-black/90 border-b border-white/10">
...
function TokenStatCard({ label, value, change, isPositive }: { label: string; value: string; change?: string; isPositive?: boolean }) {
 return (
 <div className="rounded-[24px] border border-white/10 bg-white/[0.03] p-5 hover:border-white/15 transition duration-300">
...
/* ─── ART CAMPAIGN CARD (simplified, no HoverLift) ─── */
...
function HowToBuyStep({ number, title, description, link, linkText, icon }: { number: string; title: string; description: string; link: string; linkText: string; icon: React.ReactNode }) {
 return (
 <div className="relative p-6 bg-white/[0.02] border border-white/10 rounded-[24px] hover:border-white/15 transition-all duration-300">
 <div className="absolute -top-3 -left-2 w-10 h-10 bg-red-500 rounded-xl flex items-center justify-center text-white font-black text-sm">{number}</div>
 <div className="w-12 h-12 bg-red-500/10 border border-red-500/20 rounded-xl flex items-center justify-center text-red-400 mb-4 mt-2">{icon}</div>
...
export default function Home() {
 ...
 { label: "24H BUYS", value: liveStats.buys, change: undefined, isPositive: true },
 { label: "24H SELLS", value: liveStats.sells, change: undefined, isPositive: false },
 { label: "24H VOLUME", value: liveStats.volume, change: undefined, isPositive: true },
 ] : [
 { label: "PRICE", value: "—", change: undefined, isPositive: true },
 { label: "MARKET CAP", value: "—", change: undefined, isPositive: true },
 { label: "24H BUYS", value: "—", change: undefined, isPositive: true },
 { label: "24H SELLS", value: "—", change: undefined, isPositive: false },
 { label: "24H VOLUME", value: "—", change: undefined, isPositive: true },
 ];
 ...
 {/* ─── HERO ─── */}
 <section className="relative overflow-hidden rounded-[42px] border border-white/10 bg-black/40 p-6 shadow-[0_20px_100px_rgba(0,0,0,0.45)] sm:p-10 lg:p-14">
 ...
 <br />PANICKING.
 <br />GET
 <br /><span className="text-red-500">$MAD</span>{" "}
 ...
 {/* ─── TOKEN STATS ─── */}
 <section className="mt-10 rounded-[38px] border border-white/10 bg-black/40 p-6 shadow-[0_18px_70px_rgba(0,0,0,0.35)] sm:p-8 lg:p-10">
 ...
 <span className="text-xs text-white/40">{apiError ? "API unavailable — retrying" : liveStats ? "Live data" : "Loading..."}</span>
 </div>
 </div>
 ...
 {/* ─── HOW TO BUY ─── */}
 <section id="how-to-buy" className="mt-10 rounded-[38px] border border-white/10 bg-black/40 p-6 shadow-[0_18px_70px_rgba(0,0,0,0.35)] sm:p-8 lg:p-10">
 <div className="mb-8">
 ...
 {/* ─── LIVE CHART ─── */}
 <section className="mt-10 overflow-hidden rounded-[38px] border border-white/10 bg-black/40 p-6 shadow-[0_18px_70px_rgba(0,0,0,0.35)] sm:p-8 lg:p-10">
 ...
 {/* ─── EXCHANGE SECTION ─── */}
 <section className="mt-10 overflow-hidden rounded-[38px] border border-white/10 bg-black/30 p-6 shadow-[0_18px_70px_rgba(0,0,0,0.35)] sm:p-8 lg:p-10">
 <div>
 ...
 <ExchangeLogoCard key={item.label} href={item.href} src={item.src} alt={item.alt} label={item.label} />
 ))}
 </div>
 </section>

 {/* ─── CONFESSIONS ─── */}
 <section className="mt-10 rounded-[38px] border border-white/10 bg-[linear-gradient(180deg,rgba(25,0,0,0.9),rgba(6,0,0,0.96))] p-4 shadow-[0_18px_70px_rgba(0,0,0,0.35)] sm:p-6 lg:p-8">
 <div className="mb-6 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
 <div>
