...
# Build the new section without literal dollar signs
M = chr(36) + 'MAD'
...
new_section = f'''KNOWLEDGE_DROPS = {{
    "philosophy": [
        ...
        "Seek wealth, not money or status. Wealth is having assets that earn while you sleep.\\n\\nYour {M} position is an asset. Your conviction is the leverage. — Naval Ravikant",
        "You\'re not going to get rich renting out your time. You must own equity.\\n\\nHolding {M} is owning equity in the fiction. — Naval Ravikant",
        "Play iterated games. All returns in life, whether in wealth, relationships, or knowledge, come from compound interest.\\n\\nThe daily {M} practice IS compound interest on identity. — Naval Ravikant",
        ...
        "Desire is a chosen unhappiness.\\n\\nBe {M} Rich NOW. The bag follows the being. — Naval Ravikant",
    ],
    "practical": [
        ...
        "There are no get rich quick schemes. That\'s just someone else getting rich off you.\\n\\nThe {M} path is specific knowledge + leverage + time. No shortcuts. — Naval Ravikant",
    ...
    "conviction": [
        ...
        "There are no get rich quick schemes. That\'s just someone else getting rich off you.\\n\\n{M} is specific knowledge + community leverage + time. The compound effect is real. — Naval Ravikant",
